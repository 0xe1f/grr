...
CREATE TABLE `feed_folder_trees` (
  ...
  CONSTRAINT `fk_uagh_ancestor_id` FOREIGN KEY (`ancestor_id`) REFERENCES `feed_folders` (`id`),
  CONSTRAINT `fk_uagh_descendant_id` FOREIGN KEY (`descendant_id`) REFERENCES `feed_folders` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-04-22 22:00:27
-- MySQL dump 10.13  Distrib 5.6.10, for osx10.7 (x86_64)
--
-- Host: localhost    Database: grr
-- ------------------------------------------------------
